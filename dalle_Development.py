...
image_filename = "GBR201600000000016"
image_path = f"./Development_Dataset/Development_Dataset_Images/{image_filename}.jpg"
detail = "low"  # low, high
...
img = encode_image(image_path=image_path)
...
with open(f"./result/response/{image_filename}.json", "w") as f:
...
with open(f"./result/label/{image_filename}.json", "w") as f:
    f.write(form)